  ...
  return (
    <section className='max-container'>
      ...
      <div className='py-16'>
        ...
        <div className='mt-5 flex flex-col gap-3 text-slate-500'>
          <p>I've worked with companies on different projects, leveling up my skills and teaming up with intellectual and smart people. Here's the rundown:</p>
        </div>
              ...
              >
                ...
                <ul className='my-5 list-disc ml-5 space-y-2'>
                  {experience.points.map((point, index) => (
                    <li className='text-black-500/50 font-normal pll-1 text-sm' key={index}>
                      {point}
                    </li>
                  ))}
                </ul>
